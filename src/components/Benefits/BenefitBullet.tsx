...
const BenefitBullet: React.FC<IBenefitBullet> = ({ title, description, icon }: IBenefitBullet) => {
    return (
        <motion.div
            className="flex flex-col items-center p-4 rounded-xl border border-transparent transition-colors hover:border-[#E2FDF8] hover:bg-[#E2FDF8]/35 group lg:flex-row lg:items-start lg:gap-5 text-center lg:text-left"
